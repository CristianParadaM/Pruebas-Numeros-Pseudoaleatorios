...
public class JPanelTestVarianza extends JPanel {
	...
	private void init(boolean approved) {
		...
		if (approved) {
			response.setText("<html><p style = 'text-aling:justify;'><font color= '27DB3F'>Felicidades</font>, los números han pasado la prueba debido a que la varianza (σ^2) de los \n números se encuentra entre el limite inferior y el limite superior.</p></html>");
		}else {
			response.setText("<html><p style = 'text-aling:justify;'><font color= 'e67f86'>No ha pasado la prueba</font>, debido a que la varianza (σ^2) de los números <font color= 'e67f86'>NO</font> se encuentra \n entre el limite inferior y el limite superior.</p></html>");
		}
